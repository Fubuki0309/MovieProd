...
ALTER TABLE "public".planning ADD CONSTRAINT fk_planning_scene FOREIGN KEY ( idscene ) REFERENCES "public".scene( id ) ON DELETE CASCADE ON UPDATE CASCADE;
...
COMMENT ON COLUMN "public".scene.etat IS '00 - créée\n10 - en cours d''écriture\n20 - écriture terminée\n30 - plannifiée\n40 - tournée\n50 - montée';
